...
for (i in 1:NSTUDENT) {
  ...
  sol1 <- sprintf("\\item LCS = %.4f + 3(%.4f/(%d)**0.5) = %.4f + %.4f = %.4f", p1_mean[exers$p1[i]], 
                  p1_s[exers$p1[i]], p1_n[exers$p1[i]], p1_mean[exers$p1[i]], 
                  p1_me[exers$p1[i]], p1_lcs[exers$p1[i]])
  sol2 <- sprintf("LCI = %.4f - 3(%.4f/(%d)**0.5) = %.4f - %.4f = %.4f", p1_mean[exers$p1[i]], 
                  p1_s[exers$p1[i]], p1_n[exers$p1[i]], p1_mean[exers$p1[i]], 
                  p1_me[exers$p1[i]], p1_lci[exers$p1[i]])
